package com.graydang.app.batch.bill.jobs.update.transfer.dto;
...
@Getter
@AllArgsConstructor
public class BillStatusHistoryGovTransferUpdateDto {
     ...
     */
    private BillTransferredInfoResponseDto.TransferredItem transferredItem;
}
