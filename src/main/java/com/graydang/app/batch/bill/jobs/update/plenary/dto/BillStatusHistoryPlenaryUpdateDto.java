package com.graydang.app.batch.bill.jobs.update.plenary.dto;
...
@Getter
@AllArgsConstructor
public class BillStatusHistoryPlenaryUpdateDto {
    ...
    /**
     * API 응답에서 파싱한 본회의 심의 정보.
     */
    private BillDeliverateInfoResponseDto.PlenarySessionExaminationItem plenarySessionItem;
}
